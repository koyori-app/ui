...
export const DisabledWeekends: Story = {
  args: { isDateDisabled: (date) => [0, 6].includes(new Date(`${date}T00:00:00Z`).getUTCDay()) },
};
...
function ControlledExample() {
  ...
  return (
    <div style={{ display: 'grid', gap: 12, justifyItems: 'start' }}>
      <Calendar label="予定日" locale="ja-JP" today="2026-09-16" value={date} onValueChange={setDate} />
